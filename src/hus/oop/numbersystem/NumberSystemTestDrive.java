...
public class NumberSystemTestDrive {
    public static void main(String[] args) {
        ...
        - Nén các file source code và file text kết quả chạy chương trình vào file zip có tên
          ...
          nộp lên classroom.
         */
        OriginalNumber originalNumber = new OriginalNumber("123456", 12);
        AbstractNumberConverter binaryConvert = new BinaryConverter(originalNumber);
        AbstractNumberConverter hexaConvert = new HexadecimalConverter(originalNumber);
        AbstractNumberConverter octConvert = new OctalConverter(originalNumber);
        System.out.println("Original number: " + originalNumber.getNumberPresentation());
        System.out.println("Radix: " + originalNumber.getRadix());
        System.out.println("Binary: " + binaryConvert.decimalTo(binaryConvert.toDecimal()));
        System.out.println("Hexadeccimal: " + hexaConvert.decimalTo(hexaConvert.toDecimal()));
        System.out.println("Octal: " + octConvert.decimalTo(octConvert.toDecimal()));
